...
#from p2psecure.blockchain import Blockchain#todo
...
class SecureNode(Node):
    ...
    After instantiation, you need to load or generate a public/private key for this node to be able to send and/or
    connect to the decentralized peer-to-peer network. This secure node is packed with all kinds of hashing and
    ...
    def __init__(self, host, port):
        ...
        #self.blockchain = Blockchain() #todo
